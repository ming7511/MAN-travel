<template>
  <div class="home-page">
    ...
    <div class="section">
      ...
      <div class="trip-card" v-for="trip in upcomingTrips" :key="trip.id" :style="{ backgroundColor: trip.bgColor }">
    ...
    <div class="section">
      ...
      <div class="trip-card" v-for="trip in pastTrips" :key="trip.id" :style="{ backgroundColor: trip.bgColor }">
        <div class="trip-title">{{ trip.title }}</div>
        <div class="trip-dates">{{ trip.dateRange }}</div>
        <div class="trip-duration">{{ trip.duration }}</div>
      </div>
