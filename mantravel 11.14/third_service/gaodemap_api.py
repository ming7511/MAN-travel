...
class AMapClient:
    ...
    def geocode(self, address, city=None, output="JSON"):
        ...
        try:
            ...
            if data.get("status") == "1" and data.get("geocodes"):
                ...
                adcode = geocode_info.get("adcode", "")  # 获取区域编码
                return longitude, latitude, adcode  # 返回经度、纬度和adcode
            else:
    ...
    def get_weather_info(self, city_code, extensions="all", output="JSON"):
        """
