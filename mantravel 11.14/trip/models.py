...
class TripPlan(models.Model):
    ...
    trip_destination = models.CharField(max_length=200, verbose_name="目的地")
    ...
    photo = models.URLField(max_length=500, verbose_name="图片URL", blank=True, null=True)
    location = models.CharField(max_length=100, verbose_name="经纬度", blank=True, null=True)  # 新增字段

    def __str__(self):
        return f"{self.trip_information.trip_name} - 第{self.days}天 - {self.trip_destination}"
